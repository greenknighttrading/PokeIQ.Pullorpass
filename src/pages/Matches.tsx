...
import { Sparkles, ArrowLeft, ImageOff, LogIn, Lock, ChevronLeft, ChevronRight, Wand2, Palette, Layers, Zap, BookOpen, Clock, ArrowRight, Heart as HeartIcon, X as XIcon, Pencil, Check, X as XClose, Mountain, Flame, Star, Crown, Eye, Target, Plus, HelpCircle, Trophy, Droplets, Leaf, Sun, Moon, Ghost, Snowflake, Hexagon, Circle, Swords } from 'lucide-react';
...
function TcgLinkIcon({ tcgplayerId, name, className }: { tcgplayerId?: string | null; name?: string | null; className?: string }) {
  return (
    ...
    >
      <img src={tcgplayerIcon.url} alt="TCGplayer" className="h-12 w-auto drop-shadow-[0_1px_2px_rgba(0,0,0,0.6)]" />
    </a>
  );
}
