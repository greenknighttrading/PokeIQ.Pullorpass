...
const SEALED_OR_PRODUCT_RE = /\b(booster|box|pack|deck|tin|etb|elite trainer box|bundle|blister|case|carton|collection box|premium collection|ultra premium collection|chest|toolkit|trainer kit|stadium|theme deck|starter deck|starter set|battle deck|build\s*(and|&)\s*battle|prerelease kit|sealed|unopened|factory sealed|southern islands collection|trading card game classic)\b/i;
